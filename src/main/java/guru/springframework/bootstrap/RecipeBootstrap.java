...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        UnitOfMeasure eachOum = eachUomOptional.get();
        ...
        guacRecipe.setDificalty(Difficalty.EASY);
        guacRecipe.setDirections("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                ...
                guacRecipe.getIngredients().add(new Ingredient("ripe avocados", new BigDecimal(2), eachOum));
                guacRecipe.getIngredients().add(new Ingredient("Kosher salt", new BigDecimal(".5"), teaSpoon));
        guacRecipe.addIngredient(new Ingredient("fresh lime juice", new BigDecimal(2), tableSpoon));
        guacRecipe.addIngredient(new Ingredient("minced red onion", new BigDecimal(2), eachOum));
        guacRecipe.addIngredient(new Ingredient("serrano chiles", new BigDecimal(2), eachOum));
        guacRecipe.addIngredient(new Ingredient("cilantro", new BigDecimal(2), tableSpoon));
        guacRecipe.addIngredient(new Ingredient("grated black paper", new BigDecimal(2), dash));
        guacRecipe.addIngredient(new Ingredient("ripe tomato", new BigDecimal(".5"), eachOum));
